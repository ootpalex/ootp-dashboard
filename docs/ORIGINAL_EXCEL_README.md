...
- **Per-league metadata refresh** is still recommended after each season for best accuracy. Drop your league's metadata CSVs into `leagues/<slug>/metadata/`; the pipeline auto-detects them.
